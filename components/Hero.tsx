...
const Hero = () => {
  return (
    <div className='pb-20 pt-36'>
      <div>
        <Spotlight className='-top-40 -left-10 md:=left-32 md:-top20
        h-screen' fill='white'/>
      ...
      dark:bg-grid-white/[0.05] bg-grid-black/[0.2] flex items-center
      ...
      <div className='flex justify-center relative my-20 z-10'>
        ...
        flex flex-col items-center justify-center'>
          ...
          <TextGenerateEffect className='text-center text-[40px] md:text-5xl lg:text-6xl' words='Aspiring Software Dev with Front-End, Data and Machine Learning Experience'/>
          <p className='text-center md:tracking-wider mb-4 text-small md:text-lg lg:text-2xl'>
            Hi I&apos;m Jenny, I've been coding for 5 years outside of work and would like to turn my hobby into a career!
          </p>
